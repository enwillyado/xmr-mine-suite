...
#ifdef _MSC_VER
#   define VARIANT2_SET_ROUNDING_MODE() if (VARIANT == VARIANT_2 || VARIANT == VARIANT_4) { _control87(RC_DOWN, MCW_RC); }
#else
#   define VARIANT2_SET_ROUNDING_MODE() if (VARIANT == VARIANT_2 || VARIANT == VARIANT_4) { fesetround(FE_DOWNWARD); }
#endif
...
#include "cryptonight_variant4_random_math.h"
