...
bool cryptonight_selfTestV4()
{
	...
	{
		cryptonight_hash_ctx_t<VARIANT_4>(output, test_inputs_v4[i], strlen((char*)test_inputs_v4[i]), ctx, test_heights_v4[i]);
...
template<>
void CryptoNight::cryptonight_hash_ctx<VARIANT_0>(uint8_t *__restrict__ output, const uint8_t *__restrict__ input, size_t size, cryptonight_ctx **__restrict__ ctx, const uint64_t height)
{
